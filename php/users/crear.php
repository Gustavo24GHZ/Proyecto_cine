...
if (empty($_POST['nombre_usuario']) || empty($_POST['correo_usuario']) || empty($_POST['password'])) {
    ...
    $insercion = "INSERT INTO usuarios (nombre_usuario, correo_usuario, password, tipo_usuario, activo) VALUES ('$nombre_usuario', '$correo_usuario', '$password_hash', '$tipo_usuario', '$activo')";
